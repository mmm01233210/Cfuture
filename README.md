...
> عربيًّا متماسكًا مبنيًّا على البيانات الوصفية وقاعدة معرفة المجالات. **مع
> `ANTHROPIC_API_KEY`** يقوم Claude بالفهم والتبسيط والتدقيق العلمي من الملخّص
> مباشرةً لجودةٍ أعلى بكثير.
